...
// FIXME: Need some help, what is the command I should be using to exercise the changes in  tf_to_tfl_passes?
//        this currently doesn't run the Composite-->Custom pass and fails trying to serialize composite.
//
// RUN-DISABLED: tf_tfl_translate --enable-stablehlo-conversion --input-mlir %s -o - | flatbuffer_translate --tflite-flatbuffer-to-mlir - -o - | FileCheck %s
